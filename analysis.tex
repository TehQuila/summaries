...
\begin{definition}[Series]
   Given a sequence \(x_n \mathbb{K}^\mathbb{N}\).
...
\end{remark}
\begin{example}
   \[\sum_{n = 1}^\infty \frac{1}{n^2} \rightsquigarrow s_k = \sum_{n=0}^k \frac{1}{n^2} \rightsquigarrow 1 + \frac{1}{4} + \frac{1}{9} + \ldots\]
   \((s_k)\) is increasing, now we show that it is bounded. We regard the first term seperately since we would divide by 0.
   \begin{equation*}
      \begin{split}
         s_k & = \frac{1}{1} + \sum_{n=2}^k \frac{1}{n^2} \leq 1 + \sum_{n=2}^k \frac{1}{n(n-1)} = 1 + \sum_{n=2}^k \left(\frac{1}{n-1} - \frac{1}{n} = 1 + \sum \frac{1}{n-1} - \sum \frac{1}{n} = 1 + \sum_{n=1}^{k-1} \frac{1}{n} - \sum_{n=2}^k \frac{1}{n} = 1 + 1 + \sum_{n=2}^{k-1} \frac{1}{n} - \sum_{n=2}^{k-1}\frac{1}{n} - \frac{1}{k} = 2 - \frac{1}{k} \leq 2
      \end{split}
   \end{equation*}
\end{example}
