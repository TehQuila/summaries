...
\newglossaryentry{lim}{name={limit-, cluster-, accumulation point}, description={Häufungspunkt}}
...
% Topology
\newglossaryentry{nbh}{name={neighbourhood}, description={Umgebung}}
\newglossaryentry{adp}{name={adherent point, closure point, contact point}, description={Berührungspunkt}}
\newglossaryentry{lip}{name={limit point, cluster point, accumulation point}, description={Häufungspunkt}}
\newglossaryentry{clos}{name={closure}, description={Abschluss}}
\newglossaryentry{bou}{name={boundary}, description={Rand}}

% Numerics
\newglossaryentry{roc}{name={RoC}, description={Rate of Convergence}}
\newglossaryentry{def}{name={Definiteness}, description={Definitheit}}
\newglossaryentry{split}{name={Relaxation Method}, description={Splitting-Verfahren}}
\newglossaryentry{symder}{name={Symmetric Derivative}, description={Zentraler Differenzenquotient}}
\newglossaryentry{spa}{name={sparse (matrix)}, description={dünn besetzt}}
\newglossaryentry{lapeq}{name={Laplace's Equation}, description={Potentialgleichung (Physik)}}
\newglossaryentry{rwp}{name={Boundary Value Problem}, description={Randwertproblem}}
\newglossaryentry{resid}{name={Residual}, description={Residuum}}
\newglossaryentry{linfit}{name={Line Fitting Problem}, description={Lineare Ausgleichsrechnung}}
\newglossaryentry{norm}{name={Normalengleichung}, description={normal form}}
\newglossaryentry{cur}{name={Curve Fitting}, description={Ausgleichsrechnung}}
\newglossaryentry{herm}{name={Hermitian Transpose}, description={Conjugate Transpose}}
\newglossaryentry{supp}{name={Support}, description={Träger}}
\newglossaryentry{spl}{name={Spline}, description={Polynomzug}}
\newglossaryentry{lat}{name={Lattice}, description={Gitter}}
\newglossaryentry{max}{name={Chebyshev distance}, description={Maximumsnorm}}
\newglossaryentry{samplp}{name={sampling point}, description={Stützstelle}}
\newglossaryentry{samplpp}{name={sampling point polynomial}, description={Stützstellenpolynom}}
\newglossaryentry{benign}{name={benign}, description={gutartig}}
